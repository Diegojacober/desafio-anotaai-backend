package com.diegojacober.desafioanotaai.config.aws;
...
public class AwsSnsConfig {
    ...
    public AmazonSNS amazonSNSBuilder() {
        ...
        return AmazonSNSAsyncClientBuilder.standard().withCredentials(new AWSStaticCredentialsProvider(credentials))
